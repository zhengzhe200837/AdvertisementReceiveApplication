...
public class ReceiveInfoFromServer implements Parcelable{
    ...
    public ReceiveInfoFromServer(String url, String playTime, int order_status, String name, int playTimes) {
        this.url = url;
    ...
    public String toString() {
        return "" + "url = " + url + " playTime = " + playTime + " order_status = " + order_status + " name = " + name + " playTimes = " + playTimes;
    }
